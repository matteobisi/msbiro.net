---
title: "Cloud Native Days Italy 2026: A Wrap-Up from Bologna"
date: 2026-05-22T06:29:04+01:00
tags: [
  "cloud-native", "community", "events", "bologna",
  "kubernetes", "cncf", "conference", "cloud-native-days-italy",
  "open-source", "networking", "tech-community", "organizer"
]
author: "Matteo Bisi"
showToc: true
TocOpen: false
...
canonicalURL: "https://www.msbiro.net/posts/cloud-native-days-italy-2026-recap/"
disableShare: true
hideSummary: false
searchHidden: false
...
UseHugoToc: true
cover:
    image: "CND_2026_organizers.jpeg"
    alt: "Cloud Native Days Italy 2026 organizer team with attendees"
    caption: "The CND Italy 2026 organizing team with attendees at the closing moments of the event"
    relative: true
    hidden: false
editPost:
...
Bologna, May 18-19, 2026. The fifth edition of [Cloud Native Days Italy](https://cloudnativedaysitaly.org/) is behind us, and I'm still riding the wave of energy it left behind.

Writing this post as one of the organizers feels different from a regular conference recap. Seeing something you worked on for months actually land — with real people in real rooms — is hard to describe briefly. If you want to read how the journey to this edition started, I covered it in [an earlier post](/posts/cloud-native-days-italy-2026-update/).
...
The [full speaker roster](https://cloudnativedaysitaly.org/speakers) is on the event website. What I can say is that the sessions are what people take home, and that credit belongs entirely to you.
...
![Cloud Native Days Italy 2026 organizing team](CND_2026_organizers.jpeg)
...
More details will follow in the coming months. In the meantime, join the [Telegram channel](https://t.me/cloudnativedaysitaly) to stay in the loop.
...
- [Speakers](https://cloudnativedaysitaly.org/speakers)
- [Telegram Community](https://t.me/cloudnativedaysitaly)
