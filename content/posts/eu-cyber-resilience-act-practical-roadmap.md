---
title: "The EU Cyber Resilience Act: A Practical Roadmap"
...
tags: [
  ...
  "cyber-resilience-act", "product-security", "open-source-security"
]
author: "Matteo Bisi"
showToc: true
TocOpen: false
...
hidemeta: false
comments: false
description: "A practical guide to assessing CRA scope, preparing for September 2026 reporting duties, and reaching product compliance by December 2027."
...
cover:
    ...
    alt: "EU Cyber Resilience Act practical compliance roadmap"
    caption: ""
    relative: false
    hidden: true
editPost:
...
I write this as a DevSecOps team leader. My job is to turn regulation into engineering reality, so I look at the CRA as I would any production risk: what is the deadline, what is the obligation, and what is the smallest practical path to compliance. This guide follows that path in plain language.

---

## CRA Timelines and Reporting Deadlines
...
The date that should be on your compliance calendar is not 2027. It is 11 September 2026. From that date, if an actively exploited vulnerability affects a product you have made available on the EU market, the reporting clock starts when you become aware, not when a CVE is published.
...
Whether a product was first placed on the market before December 2027 does not, by itself, settle Article 14 reporting. Assess reporting obligations for products that remain within their declared support period. A customer continuing to use an end-of-support product does not, by itself, extend that period. Your preparation cannot wait for a new release cycle.
...
Capacity is the practical problem. The rules that allow notified bodies to be designated apply from June 2026, and the available standards and notified-body capacity must be checked for the product category. If your product needs a notified body, start identifying candidates early. Start classification with CRA Annexes III and IV, then use Implementing Regulation (EU) 2025/2392 for technical descriptions of the listed categories. Without a classification for each product line, you cannot plan.
...
## A Practical CRA Compliance Roadmap for the Next 18 Months

The CRA feels vague until you turn it into an ordered plan. Here is the roadmap I would use as a DevSecOps team, with the practices and tooling that make each step concrete.
...
## What FOSS Developers Need to Do

The answer depends on your role and circumstances. Free and open source software developed or supplied outside a commercial activity is excluded from the CRA. The decisive question is whether the product is supplied in the course of a commercial activity. A fee for maintenance, updates, or support is a strong commercial indicator, even where the software can be downloaded without charge.
...
The practical answer for any developer is simple. Publish a clear security contact and disclosure process, such as a SECURITY.md. Document your security practices. If the project is supplied commercially, assess the CRA carefully and do not assume that an open-source licence or free download excludes it.
...
An engineering mindset is the practical way to meet the CRA. Break the legal text into obligations, the obligations into artefacts, and the artefacts into a delivery plan. Test the plan, not only the theory. Simulate the incident before a real vulnerability starts the reporting clock.
